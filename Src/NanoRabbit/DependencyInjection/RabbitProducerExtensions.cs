...
public static class RabbitProducerExtensions
{
    ...
    /// <returns></returns>
    public static IServiceCollection AddProducer<TProducer>(this IServiceCollection services, string connectionName,
        string producerName)
        where TProducer : RabbitProducer
    {
        services.AddSingleton<TProducer>(provider =>
        {
            ...
            var producer = ActivatorUtilities.CreateInstance<TProducer>(provider, connectionName, producerName,
